// OpenAICompatibleAdapter.swift — infrastructure adapter placeholder
// Implements: LLMProviderPort from LLMProvider (OpenAI-compatible endpoints,
//             e.g. Ollama, LM Studio, vLLM, Azure OpenAI)
...
/// Namespace marker for the OpenAICompatibleAdapter adapter target.
///
...
public enum OpenAICompatibleAdapter: Sendable {
