// AWSExecCredentialAdapter.swift — infrastructure adapter placeholder
// Implements: ExecCredentialPort from ClusterConnectivity (AWS EKS)
// Library: soto-project/soto SotoCore + SotoSTS (Tier A per ADR-0019)
...
/// Namespace marker for the AWSExecCredentialAdapter adapter target.
///
...
public enum AWSExecCredentialAdapter: Sendable {
