// ClusterIntelligence.swift — domain core placeholder
// Bounded context: cluster_intelligence (per ADR-0005)
// Status: skeleton; domain types pending CUE schema extraction.
import Foundation

/// Namespace marker for the ClusterIntelligence bounded context.
///
...
public enum ClusterIntelligence: Sendable {
